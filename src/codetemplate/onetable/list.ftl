...
<!DOCTYPE html>
	...
	<body class="page-header-fixed page-sidebar-closed-hide-logo page-sidebar-closed-hide-logo">
		...
		<div class="page-container">
					...
					<div class="page-content" >
						<div class="page-head">
							<div class="page-title">
								<h1><i class="icon-grid" style="font-size: 20px;"></i>&nbsp;${table.tableRemark}管理   </h1>
							</div>
						...
						<ul class="page-breadcrumb breadcrumb">
							...
							<li>
								<a href="javascript:;">${table.tableRemark}管理</a>
							</li>
						</ul>
							<div class="row">
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-globe"></i>${table.tableRemark}管理
											</div>
											<div class="actions">
												<a href="<#noparse>${base}</#noparse>/admin/${classNameLowerCase}/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														...
														<tbody>
															[#list page.content as ${classNameLowerCase}]
																<tr class="gradeX [#if (${classNameLowerCase}_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="<#noparse>${</#noparse>${classNameLowerCase}.id<#noparse>}</#noparse>" ></span>
																	</td>
																	<#list table.columns as column>
				                                                    <td><#noparse>${</#noparse> ${classNameLowerCase}.${column.columnNameLowerCase}<#noparse>}</#noparse></td>
				                                                    
				                                                    </#list>
																	<td style="width: 125px;">
																		<a href="<#noparse>${base}</#noparse>/admin/${classNameLowerCase}/edit/<#noparse>${</#noparse>${classNameLowerCase}.id<#noparse>}</#noparse>.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="<#noparse>${base}</#noparse>/admin/${classNameLowerCase}/view/<#noparse>${</#noparse>${classNameLowerCase}.id<#noparse>}</#noparse>.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
			...
			<link rel="stylesheet" type="text/css" href="<#noparse>${base}</#noparse>/resources/plugin/metronic/global/plugins/bootstrap-toastr/toastr.min.css"/>
			<script src="<#noparse>${base}</#noparse>/resources/plugin/metronic/global/plugins/bootstrap-toastr/toastr.min.js"></script>
			<script src="<#noparse>${base}</#noparse>/resources/plugin/metronic/global/plugins/bootbox/bootbox.min.js" type="text/javascript"></script>
