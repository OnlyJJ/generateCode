...
import com.pousheng.generator.core.PoushengGenerator;
...
public class GeneratorClient {
	...
	public void generatorOneTableInner() {
		try {
			...
			tableVO.setClassName("RoleInner"); //设置类名....
			tableVO.setPackageName("roleinner");//包名.....
			tableVO.setTableName("t_role"); //数据库表名..
	...
	public void generatorOneTableModel() {
		try {
			TableVO tableVO = new TableVO();
			tableVO.setClassName("User");//设置类名
			tableVO.setPackageName("user");//包名
			tableVO.setTableName("sys_user");//数据库表名
	...
	public void generatorOneToMany() {
		try {
			TableVO tableVO = new TableVO();
			tableVO.setClassName("Test");
			tableVO.setPackageName("test");
			tableVO.setTableName("t_test");

			SubTableVO sub = new SubTableVO();
			sub.setClassName("User");
			sub.setPackageName("user");
			sub.setTableName("t_user");

			sub.setRelationKeys("TEST_ID", "TEST_ID"); //设置与主表的关联key
...
//			tableVO.addSubTable(sub2);
	...
	public static void main(String[] args) {
		new com.pousheng.generator.core.window.GeneratorWindow().pack();
		//new  GeneratorClient().generatorOneToMany();
	}
