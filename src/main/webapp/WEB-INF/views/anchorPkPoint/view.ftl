				...
				<div class="page-content-wrapper">
					<div class="page-content" >
						...
						class="fa fa-circle"></i></li>
							<li>
								<a href="javascript:;">查看pk积分记录表详情</a>
							</li>
						</ul>
							<div class="row">
								<div class="col-md-12">
														...
														<div class="row">
															<div class="col-md-6">
																<div class="form-group">
																	<label class="control-label col-md-3">主播:</label>
																	<div class="col-md-9">
																		<p class="form-control-static">
																			${anchorPkPoint.userId}
																		</p>
																	</div>
																</div>
															</div>
															<div class="col-md-6">
																<div class="form-group">
																	<label class="control-label col-md-3">pk总积分:</label>
																	<div class="col-md-9">
																		<p class="form-control-static">
																			${anchorPkPoint.totalPoints}
																		</p>
																	</div>
																</div>
															</div>
