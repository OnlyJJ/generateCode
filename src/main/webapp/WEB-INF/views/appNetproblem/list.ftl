					...
					<div class="page-content" >
						<div class="page-head">
							<div class="page-title">
								<h1><i class="icon-grid" style="font-size: 20px;"></i>&nbsp;app用户网络诊断数据管理   </h1>
							</div>
						...
						<ul class="page-breadcrumb breadcrumb">
							...
							<li>
								<a href="javascript:;">app用户网络诊断数据管理</a>
							</li>
						</ul>
							<div class="row">
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-globe"></i>app用户网络诊断数据管理
											</div>
											<div class="actions">
												<a href="${base}/admin/appNetproblem/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														<thead>
															<tr role="row">
																<th class="table-checkbox sorting_disabled" rowspan="1" colspan="1" style="width: 24px;">
				                                                 ...
				                                                 <th ></th> 
				                                                 <th ></th> 
				                                                 <th >联系方式，qq，微信，微博，手机登</th> 
				                                                 <th >问题描述：1视频卡顿，2聊天卡顿，3手机卡顿，4其他</th> 
				                                                 <th >详细说明</th> 
				                                                 <th >网络诊断结果</th> 
				                                                 <th >提交时间</th> 
														...
														<tbody>
															[#list page.content as appNetproblem]
																<tr class="gradeX [#if (appNetproblem_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${appNetproblem.id}" ></span>
																	</td>
				                                                    <td>${ appNetproblem.id}</td>
				                                                    
				                                                    <td>${ appNetproblem.userId}</td>
				                                                    
				                                                    <td>${ appNetproblem.contact}</td>
				                                                    
				                                                    <td>${ appNetproblem.description}</td>
				                                                    
				                                                    <td>${ appNetproblem.content}</td>
				                                                    
				                                                    <td>${ appNetproblem.diagnosisResult}</td>
				                                                    
				                                                    <td>${ appNetproblem.addTime}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/appNetproblem/edit/${appNetproblem.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/appNetproblem/view/${appNetproblem.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
