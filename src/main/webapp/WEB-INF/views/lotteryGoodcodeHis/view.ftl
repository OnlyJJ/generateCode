				...
				<div class="page-content-wrapper">
					<div class="page-content" >
						...
						class="fa fa-circle"></i></li>
							<li>
								<a href="javascript:;">查看靓号抽奖记录表详情</a>
							</li>
						</ul>
							<div class="row">
								<div class="col-md-12">
														...
														<div class="row">
															<div class="col-md-6">
																<div class="form-group">
																	<label class="control-label col-md-3">抽奖用户:</label>
																	<div class="col-md-9">
																		<p class="form-control-static">
																			${lotteryGoodcodeHis.userId}
																		</p>
																	</div>
																</div>
															</div>
															<div class="col-md-6">
																<div class="form-group">
																	<label class="control-label col-md-3">抽中的靓号:</label>
																	<div class="col-md-9">
																		<p class="form-control-static">
																			${lotteryGoodcodeHis.code}
																		</p>
																	</div>
																</div>
															</div>
