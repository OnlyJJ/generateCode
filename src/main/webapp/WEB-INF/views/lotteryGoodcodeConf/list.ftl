					...
					<div class="page-content" >
						<div class="page-head">
							<div class="page-title">
								<h1><i class="icon-grid" style="font-size: 20px;"></i>&nbsp;靓号抽奖配置表管理   </h1>
							</div>
								...
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-globe"></i>靓号抽奖配置表管理
											</div>
											<div class="actions">
												<a href="${base}/admin/lotteryGoodcodeConf/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														<thead>
															<tr role="row">
																<th class="table-checkbox sorting_disabled" rowspan="1" colspan="1" style="width: 24px;">
				                                                 ...
				                                                 <th >账号</th> 
				                                                 <th >是否使用，0-否，1-是</th> 
				                                                 <th >靓号等级 1，至尊 2 顶级 3 超级 4 主题 5自定义</th> 
														...
														<tbody>
															[#list page.content as lotteryGoodcodeConf]
																<tr class="gradeX [#if (lotteryGoodcodeConf_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${lotteryGoodcodeConf.id}" ></span>
																	</td>
				                                                    <td>${ lotteryGoodcodeConf.id}</td>
				                                                    
				                                                    <td>${ lotteryGoodcodeConf.code}</td>
				                                                    
				                                                    <td>${ lotteryGoodcodeConf.useStatus}</td>
				                                                    
				                                                    <td>${ lotteryGoodcodeConf.level}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/lotteryGoodcodeConf/edit/${lotteryGoodcodeConf.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/lotteryGoodcodeConf/view/${lotteryGoodcodeConf.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
