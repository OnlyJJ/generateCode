			...
			<div class="page-content">
				...
				<div class="page-head">
					...
					<div class="page-title">
						<h1>
							<i class="icon-grid" style="font-size: 20px;"></i>&nbsp;编辑靓号抽奖配置表
						</h1>
					</div>
				...
				<ul class="page-breadcrumb breadcrumb">
					...
					<li><a href="javascript:;">靓号抽奖配置表</a></li>
				</ul>
					...
					<div class="col-md-12">
						<div class="portlet light bordered">
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form id="inputForm"
									action="${base}/admin/lotteryGoodcodeConf/update.jhtml"
									method="post" class="form-horizontal">
									<input type="hidden" name="id" value="${lotteryGoodcodeConf.id}" />
									<div class="form-body">
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<div class="col-md-9">
														...
														value="${lotteryGoodcodeConf.code}"	maxlength="200" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-3">是否使用，0-否，1-是</label>
													<div class="col-md-9">
														<input type="text" name="useStatus"
															id="useStatus" class="form-control"
														value="${lotteryGoodcodeConf.useStatus}"	maxlength="200" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-3">靓号等级 1，至尊 2 顶级 3 超级 4 主题 5自定义</label>
													<div class="col-md-9">
														<input type="text" name="level"
															id="level" class="form-control"
														value="${lotteryGoodcodeConf.level}"	maxlength="200" />
													</div>
												</div>
											</div>
										</div>
