														...
														<div class="row">
															<div class="col-md-6">
																<div class="form-group">
																	<label class="control-label col-md-3">app应用注册信鸽生成id:</label>
																	<div class="col-md-9">
															...
															<div class="col-md-6">
																<div class="form-group">
																	<label class="control-label col-md-3">app应用注册信鸽生成的密钥:</label>
																	<div class="col-md-9">
																		<p class="form-control-static">
																			${pushConfig.secretKey}
																		</p>
																	</div>
																</div>
															</div>
															<div class="col-md-6">
																<div class="form-group">
																	<label class="control-label col-md-3">客户端类型 3-IOS；0-Android；默认0:</label>
																	<div class="col-md-9">
																		<p class="form-control-static">
																			${pushConfig.appType}
																		</p>
															...
															<div class="col-md-6">
																<div class="form-group">
																	<label class="control-label col-md-3">app包名:</label>
																	<div class="col-md-9">
																		<p class="form-control-static">
																			${pushConfig.pckName}
																		</p>
															...
															<div class="col-md-6">
																<div class="form-group">
																	<label class="control-label col-md-3">启用状态，1-启用，0-停用:</label>
																	<div class="col-md-9">
																		<p class="form-control-static">
																			${pushConfig.useStatus}
																		</p>
																	</div>
																</div>
															</div>
