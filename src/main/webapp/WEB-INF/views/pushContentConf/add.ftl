			...
			<div class="page-content">
				...
				<div class="page-head">
					...
					<div class="page-title">
						<h1>
							<i class="icon-grid" style="font-size: 20px;"></i>&nbsp;添加推送消息配置
						</h1>
					</div>
				...
				<ul class="page-breadcrumb breadcrumb">
					...
					<li><a href="javascript:;">添加推送消息配置</a></li>
				</ul>
					...
					<div class="col-md-12">
						<div class="portlet light bordered">
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form id="inputForm"
									action="${base}/admin/pushContentConf/save.jhtml"
									...
									<div class="form-body">
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-3">内容<span class="required" aria-required="true"> * </span></label>
													<div class="col-md-9">
