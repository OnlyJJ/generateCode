		...
		<div class="page-content-wrapper">
			<div class="page-content">
				...
				<ul class="page-breadcrumb breadcrumb">
					...
					<li><a href="${base}/admin/anchorPwall/list.jhtml">管理</a><i
					...
					<div class="col-md-12">
						<div class="portlet light bordered">
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form id="inputForm"
									action="${base}/admin/anchorPwall/update.jhtml"
									method="post" class="form-horizontal">
									<input type="hidden" name="id" value="${anchorPwall.id}" />
									<div class="form-body">
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-3">帮推用户(做冗余)</label>
													<div class="col-md-9">
														<input type="text" name="userId"
															id="userId" class="form-control"
														value="${anchorPwall.userId}"	maxlength="200" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-3">上墙主播</label>
													<div class="col-md-9">
														<input type="text" name="anchorId"
															id="anchorId" class="form-control"
														value="${anchorPwall.anchorId}"	maxlength="200" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-3">上墙时间</label>
													<div class="col-md-9">
														<input type="text" name="addTime"
															id="addTime" class="form-control"
														value="${anchorPwall.addTime}"	maxlength="200" />
													</div>
												</div>
											</div>
										</div>
