					...
					<div class="page-content" >
						<div class="page-head">
							<div class="page-title">
								<h1><i class="icon-grid" style="font-size: 20px;"></i>&nbsp;动态内容举报信息管理   </h1>
							</div>
						...
						<ul class="page-breadcrumb breadcrumb">
							...
							<li>
								<a href="javascript:;">动态内容举报信息管理</a>
							</li>
						</ul>
							<div class="row">
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-globe"></i>动态内容举报信息管理
											</div>
											<div class="actions">
												<a href="${base}/admin/diaryInfoAccusation/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														<thead>
															<tr role="row">
																<th class="table-checkbox sorting_disabled" rowspan="1" colspan="1" style="width: 24px;">
				                                                 ...
				                                                 <th >相关动态id</th> 
				                                                 <th >举报信息说明</th> 
				                                                 <th >后台管理员处理状态,0:新建(未处理),1:删除(已处理)</th> 
				                                                 <th >管理员操作的用户userId</th> 
				                                                 <th >管理员操作时间</th> 
				                                                 <th >管理员操作说明</th> 
				                                                 <th >举报来源ip</th> 
				                                                 <th >举报来源地址</th> 
														...
														<tbody>
															[#list page.content as diaryInfoAccusation]
																<tr class="gradeX [#if (diaryInfoAccusation_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${diaryInfoAccusation.id}" ></span>
																	</td>
				                                                    <td>${ diaryInfoAccusation.id}</td>
				                                                    
				                                                    <td>${ diaryInfoAccusation.userId}</td>
				                                                    
				                                                    <td>${ diaryInfoAccusation.userName}</td>
				                                                    
				                                                    <td>${ diaryInfoAccusation.toUserId}</td>
				                                                    
				                                                    <td>${ diaryInfoAccusation.toUserName}</td>
				                                                    
				                                                    <td>${ diaryInfoAccusation.accusationTime}</td>
				                                                    
				                                                    <td>${ diaryInfoAccusation.diaryInfoId}</td>
				                                                    
				                                                    <td>${ diaryInfoAccusation.accusationInfo}</td>
				                                                    
				                                                    <td>${ diaryInfoAccusation.mgrState}</td>
				                                                    
				                                                    <td>${ diaryInfoAccusation.operateUserId}</td>
				                                                    
				                                                    <td>${ diaryInfoAccusation.operateTime}</td>
				                                                    
				                                                    <td>${ diaryInfoAccusation.operateComment}</td>
				                                                    
				                                                    <td>${ diaryInfoAccusation.accusationIp}</td>
				                                                    
				                                                    <td>${ diaryInfoAccusation.accusationAddr}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/diaryInfoAccusation/edit/${diaryInfoAccusation.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/diaryInfoAccusation/view/${diaryInfoAccusation.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
