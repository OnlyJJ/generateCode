			...
			<div class="page-content">
				...
				<div class="page-head">
					...
					<div class="page-title">
						<h1>
							<i class="icon-grid" style="font-size: 20px;"></i>&nbsp;添加动态内容举报信息
						</h1>
					</div>
				...
				<ul class="page-breadcrumb breadcrumb">
					...
					<li><a href="javascript:;">添加动态内容举报信息</a></li>
				</ul>
					...
					<div class="col-md-12">
						<div class="portlet light bordered">
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form id="inputForm"
									action="${base}/admin/diaryInfoAccusation/save.jhtml"
									...
									<div class="form-body">
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-3">举报人当时的昵称<span class="required" aria-required="true"> * </span></label>
													<div class="col-md-9">
											...
											<div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-3">被举报人当时的昵称<span class="required" aria-required="true"> * </span></label>
													<div class="col-md-9">
											...
											<div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-3">相关动态id<span class="required" aria-required="true"> * </span></label>
													<div class="col-md-9">
											...
											<div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-3">后台管理员处理状态,0:新建(未处理),1:删除(已处理)<span class="required" aria-required="true"> * </span></label>
													<div class="col-md-9">
											...
											<div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-3">举报来源ip<span class="required" aria-required="true"> * </span></label>
													<div class="col-md-9">
											...
											<div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-3">举报来源地址<span class="required" aria-required="true"> * </span></label>
													<div class="col-md-9">
				...
				$(document).ready(function(){
					...
					$inputForm.validate({
						rules: {
                                ...
                                accusationIp:{ required: true},
                                accusationAddr:{required: true}
						}
					});
				});
			</script>
