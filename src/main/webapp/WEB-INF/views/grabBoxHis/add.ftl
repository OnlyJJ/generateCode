					...
					<div class="col-md-12">
						<div class="portlet light bordered">
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form id="inputForm"
									action="${base}/admin/grabBoxHis/save.jhtml"
									...
									<div class="form-body">
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-3">宝箱记录表id：t_grab_box_record<span class="required" aria-required="true"> * </span></label>
													<div class="col-md-9">
