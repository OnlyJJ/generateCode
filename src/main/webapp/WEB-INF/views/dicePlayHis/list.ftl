					...
					<div class="page-content" >
						<div class="page-head">
							<div class="page-title">
								<h1><i class="icon-grid" style="font-size: 20px;"></i>&nbsp;玩家猜大小游戏记录表管理   </h1>
							</div>
						...
						<ul class="page-breadcrumb breadcrumb">
							...
							<li>
								<a href="javascript:;">玩家猜大小游戏记录表管理</a>
							</li>
						</ul>
							<div class="row">
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-globe"></i>玩家猜大小游戏记录表管理
											</div>
											<div class="actions">
												<a href="${base}/admin/dicePlayHis/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														...
														<tbody>
															[#list page.content as dicePlayHis]
																<tr class="gradeX [#if (dicePlayHis_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${dicePlayHis.id}" ></span>
																	</td>
				                                                    <td>${ dicePlayHis.id}</td>
				                                                    
				                                                    <td>${ dicePlayHis.roomId}</td>
				                                                    
				                                                    <td>${ dicePlayHis.userId}</td>
				                                                    
				                                                    <td>${ dicePlayHis.stakeGlod}</td>
				                                                    
				                                                    <td>${ dicePlayHis.returnGlod}</td>
				                                                    
				                                                    <td>${ dicePlayHis.creatTime}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/dicePlayHis/edit/${dicePlayHis.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/dicePlayHis/view/${dicePlayHis.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
