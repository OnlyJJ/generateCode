...
<!DOCTYPE html>
	...
	<body class="page-header-fixed page-sidebar-closed-hide-logo page-sidebar-closed-hide-logo">
		...
		<div class="page-container">
			[@sidebar pattern="admin:grabBoxRecord"][#include "/admin/include/sidebar.ftl"][/@sidebar]
			<!-- BEGIN CONTENT -->
								...
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											...
											<div class="actions">
												<a href="${base}/admin/grabBoxRecord/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														<thead>
															<tr role="row">
																<th class="table-checkbox sorting_disabled" rowspan="1" colspan="1" style="width: 24px;">
				                                                 ...
				                                                 <th ></th> 
				                                                 <th >宝箱所属房间id</th> 
				                                                 <th >使用状态，0-默认新建，1-正在使用，2-已抢完</th> 
				                                                 <th >已抢宝箱次数</th> 
				                                                 <th >创建时间</th> 
														...
														<tbody>
															[#list page.content as grabBoxRecord]
																<tr class="gradeX [#if (grabBoxRecord_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${grabBoxRecord.id}" ></span>
																	</td>
				                                                    <td>${ grabBoxRecord.id}</td>
				                                                    
				                                                    <td>${ grabBoxRecord.roomId}</td>
				                                                    
				                                                    <td>${ grabBoxRecord.uesFlag}</td>
				                                                    
				                                                    <td>${ grabBoxRecord.grabCount}</td>
				                                                    
				                                                    <td>${ grabBoxRecord.creatTime}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/grabBoxRecord/edit/${grabBoxRecord.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/grabBoxRecord/view/${grabBoxRecord.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
