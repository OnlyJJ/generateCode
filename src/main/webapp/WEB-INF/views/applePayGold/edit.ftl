					...
					<div class="col-md-12">
						<div class="portlet light bordered">
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form id="inputForm"
									action="${base}/admin/applePayGold/update.jhtml"
									method="post" class="form-horizontal">
									<input type="hidden" name="id" value="${applePayGold.id}" />
									<div class="form-body">
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-3">类型，0-内购，1-第三方</label>
													<div class="col-md-9">
														<input type="text" name="type"
															id="type" class="form-control"
														value="${applePayGold.type}"	maxlength="200" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-3">充值金币所需的金额，单位：分</label>
													<div class="col-md-9">
														<input type="text" name="money"
															id="money" class="form-control"
														value="${applePayGold.money}"	maxlength="200" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-3">充值的金币</label>
													<div class="col-md-9">
														<input type="text" name="gold"
															id="gold" class="form-control"
														value="${applePayGold.gold}"	maxlength="200" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													...
													<div class="col-md-9">
														...
														value="${applePayGold.creatTime}"	maxlength="200" />
													</div>
												</div>
											</div>
										</div>
