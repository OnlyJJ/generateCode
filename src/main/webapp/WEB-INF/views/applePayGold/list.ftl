								...
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											...
											<div class="actions">
												<a href="${base}/admin/applePayGold/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														...
														<tbody>
															[#list page.content as applePayGold]
																<tr class="gradeX [#if (applePayGold_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${applePayGold.id}" ></span>
																	</td>
				                                                    <td>${ applePayGold.id}</td>
				                                                    
				                                                    <td>${ applePayGold.type}</td>
				                                                    
				                                                    <td>${ applePayGold.money}</td>
				                                                    
				                                                    <td>${ applePayGold.gold}</td>
				                                                    
				                                                    <td>${ applePayGold.creatTime}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/applePayGold/edit/${applePayGold.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/applePayGold/view/${applePayGold.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
