					...
					<div class="page-content" >
						<div class="page-head">
							<div class="page-title">
								<h1><i class="icon-grid" style="font-size: 20px;"></i>&nbsp;主播抽奖金币流水记录管理   </h1>
							</div>
						...
						<ul class="page-breadcrumb breadcrumb">
							...
							<li>
								<a href="javascript:;">主播抽奖金币流水记录管理</a>
							</li>
						</ul>
							<div class="row">
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-globe"></i>主播抽奖金币流水记录管理
											</div>
											<div class="actions">
												<a href="${base}/admin/anchorPrizeGoldbook/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														<thead>
															<tr role="row">
																<th class="table-checkbox sorting_disabled" rowspan="1" colspan="1" style="width: 24px;">
				                                                 ...
				                                                 <th ></th> 
				                                                 <th >对应t_anchor_prize_record表的id</th> 
				                                                 <th >主播id</th> 
				                                                 <th >抵押的金币</th> 
				                                                 <th >实际奖励扣除的金币</th> 
				                                                 <th >返还给主播的金币（未奖励完）</th> 
														...
														<tbody>
															[#list page.content as anchorPrizeGoldbook]
																<tr class="gradeX [#if (anchorPrizeGoldbook_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${anchorPrizeGoldbook.id}" ></span>
																	</td>
				                                                    <td>${ anchorPrizeGoldbook.id}</td>
				                                                    
				                                                    <td>${ anchorPrizeGoldbook.recordId}</td>
				                                                    
				                                                    <td>${ anchorPrizeGoldbook.anchorId}</td>
				                                                    
				                                                    <td>${ anchorPrizeGoldbook.pledgeGold}</td>
				                                                    
				                                                    <td>${ anchorPrizeGoldbook.prizeGold}</td>
				                                                    
				                                                    <td>${ anchorPrizeGoldbook.retGold}</td>
				                                                    
				                                                    <td>${ anchorPrizeGoldbook.createTime}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/anchorPrizeGoldbook/edit/${anchorPrizeGoldbook.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/anchorPrizeGoldbook/view/${anchorPrizeGoldbook.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
