					...
					<div class="page-content" >
						<div class="page-head">
							<div class="page-title">
								<h1><i class="icon-grid" style="font-size: 20px;"></i>&nbsp;抽奖配置表管理   </h1>
							</div>
								...
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-globe"></i>抽奖配置表管理
											</div>
											<div class="actions">
												<a href="${base}/admin/lotteryConf/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														<thead>
															<tr role="row">
																<th class="table-checkbox sorting_disabled" rowspan="1" colspan="1" style="width: 24px;">
				                                                 ...
				                                                 <th ></th> 
				                                                 <th >标题</th> 
				                                                 <th >消费类型（目前以积分形式抽奖：1）</th> 
				                                                 <th >抽奖一次，所花费的数量（积分或其他）</th> 
				                                                 <th >抽奖次数，默认1次，可配置多次</th> 
				                                                 <th >启用状态，默认0-未启用，1-启用</th> 
				                                                 <th >开始时间</th> 
				                                                 <th >结束时间</th> 
				                                                 <th >抽奖说明</th> 
														...
														<tbody>
															[#list page.content as lotteryConf]
																<tr class="gradeX [#if (lotteryConf_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${lotteryConf.id}" ></span>
																	</td>
				                                                    <td>${ lotteryConf.id}</td>
				                                                    
				                                                    <td>${ lotteryConf.title}</td>
				                                                    
				                                                    <td>${ lotteryConf.consumeType}</td>
				                                                    
				                                                    <td>${ lotteryConf.consumeNum}</td>
				                                                    
				                                                    <td>${ lotteryConf.frequency}</td>
				                                                    
				                                                    <td>${ lotteryConf.is_use}</td>
				                                                    
				                                                    <td>${ lotteryConf.beginTime}</td>
				                                                    
				                                                    <td>${ lotteryConf.endTime}</td>
				                                                    
				                                                    <td>${ lotteryConf.content}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/lotteryConf/edit/${lotteryConf.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/lotteryConf/view/${lotteryConf.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
