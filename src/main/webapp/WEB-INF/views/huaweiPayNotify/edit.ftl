					...
					<div class="col-md-12">
						<div class="portlet light bordered">
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form id="inputForm"
									action="${base}/admin/huaweiPayNotify/update.jhtml"
									method="post" class="form-horizontal">
									<input type="hidden" name="id" value="${huaweiPayNotify.id}" />
									<div class="form-body">
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-3">服务器生成的订单号</label>
													<div class="col-md-9">
														<input type="text" name="orderId"
															id="orderId" class="form-control"
														value="${huaweiPayNotify.orderId}"	maxlength="200" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-3">华为支付平台订单号</label>
													<div class="col-md-9">
														<input type="text" name="outTradeNo"
															id="outTradeNo" class="form-control"
														value="${huaweiPayNotify.outTradeNo}"	maxlength="200" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-3">0，表示支付成功</label>
													<div class="col-md-9">
														<input type="text" name="returnCode"
															id="returnCode" class="form-control"
														value="${huaweiPayNotify.returnCode}"	maxlength="200" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-3">回调通知时间</label>
													<div class="col-md-9">
														<input type="text" name="notifyTime"
															id="notifyTime" class="form-control"
														value="${huaweiPayNotify.notifyTime}"	maxlength="200" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-3">服务器生成记录的时间</label>
													<div class="col-md-9">
														<input type="text" name="recordTime"
															id="recordTime" class="form-control"
														value="${huaweiPayNotify.recordTime}"	maxlength="200" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-3">回调的签名</label>
													<div class="col-md-9">
														<input type="text" name="sign"
															id="sign" class="form-control"
														value="${huaweiPayNotify.sign}"	maxlength="200" />
													</div>
												</div>
											</div>
										</div>
