								...
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											...
											<div class="actions">
												<a href="${base}/admin/huaweiPayNotify/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														...
														<tbody>
															[#list page.content as huaweiPayNotify]
																<tr class="gradeX [#if (huaweiPayNotify_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${huaweiPayNotify.id}" ></span>
																	</td>
				                                                    <td>${ huaweiPayNotify.id}</td>
				                                                    
				                                                    <td>${ huaweiPayNotify.orderId}</td>
				                                                    
				                                                    <td>${ huaweiPayNotify.outTradeNo}</td>
				                                                    
				                                                    <td>${ huaweiPayNotify.returnCode}</td>
				                                                    
				                                                    <td>${ huaweiPayNotify.notifyTime}</td>
				                                                    
				                                                    <td>${ huaweiPayNotify.recordTime}</td>
				                                                    
				                                                    <td>${ huaweiPayNotify.sign}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/huaweiPayNotify/edit/${huaweiPayNotify.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/huaweiPayNotify/view/${huaweiPayNotify.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
