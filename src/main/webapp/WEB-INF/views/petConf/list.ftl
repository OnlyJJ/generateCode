					...
					<div class="page-content" >
						<div class="page-head">
							<div class="page-title">
								<h1><i class="icon-grid" style="font-size: 20px;"></i>&nbsp;宠物配置表管理   </h1>
							</div>
								...
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-globe"></i>宠物配置表管理
											</div>
											<div class="actions">
												<a href="${base}/admin/petConf/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														<thead>
															<tr role="row">
																<th class="table-checkbox sorting_disabled" rowspan="1" colspan="1" style="width: 24px;">
				                                                 ...
				                                                 <th >主键id，作为宠物petId</th> 
				                                                 <th >默认的宠物名，用户可修改</th> 
				                                                 <th >孵化时间，单位:分钟</th> 
				                                                 <th >属性id，关联宠物属性配置表id</th> 
				                                                 <th >是否有效，0:无效，1:有效</th> 
														...
														<tbody>
															[#list page.content as petConf]
																<tr class="gradeX [#if (petConf_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${petConf.id}" ></span>
																	</td>
				                                                    <td>${ petConf.id}</td>
				                                                    
				                                                    <td>${ petConf.petName}</td>
				                                                    
				                                                    <td>${ petConf.hatchTime}</td>
				                                                    
				                                                    <td>${ petConf.natureId}</td>
				                                                    
				                                                    <td>${ petConf.vaild}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/petConf/edit/${petConf.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/petConf/view/${petConf.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
