...
<!DOCTYPE html>
	...
	<body class="page-header-fixed page-sidebar-closed-hide-logo page-sidebar-closed-hide-logo">
		...
		<div class="page-container">
			[@sidebar pattern="admin:pushUserSetChild"][#include "/admin/include/sidebar.ftl"][/@sidebar]
			<!-- BEGIN CONTENT -->
				<div class="page-content-wrapper">
					<div class="page-content" >
						<div class="page-head">
							<div class="page-title">
								<h1><i class="icon-grid" style="font-size: 20px;"></i>&nbsp;用户消息推送设置-提醒设置子表管理   </h1>
							</div>
						...
						<ul class="page-breadcrumb breadcrumb">
							...
							<li>
								<a href="javascript:;">用户消息推送设置-提醒设置子表管理</a>
							</li>
						</ul>
							<div class="row">
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-globe"></i>用户消息推送设置-提醒设置子表管理
											</div>
											<div class="actions">
												<a href="${base}/admin/pushUserSetChild/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														<thead>
															<tr role="row">
																<th class="table-checkbox sorting_disabled" rowspan="1" colspan="1" style="width: 24px;">
				                                                 ...
				                                                 <th ></th> 
				                                                 <th >关联t_push_user_set表的主键id</th> 
				                                                 <th >状态，0关闭，1接收，默认1</th> 
				                                                 <th >添加时间</th> 
														...
														<tbody>
															[#list page.content as pushUserSetChild]
																<tr class="gradeX [#if (pushUserSetChild_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${pushUserSetChild.id}" ></span>
																	</td>
				                                                    <td>${ pushUserSetChild.id}</td>
				                                                    
				                                                    <td>${ pushUserSetChild.userSetId}</td>
				                                                    
				                                                    <td>${ pushUserSetChild.openFlag}</td>
				                                                    
				                                                    <td>${ pushUserSetChild.creatTime}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/pushUserSetChild/edit/${pushUserSetChild.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/pushUserSetChild/view/${pushUserSetChild.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
