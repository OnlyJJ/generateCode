...
<!DOCTYPE html>
	...
	<body class="page-header-fixed page-sidebar-closed-hide-logo page-sidebar-closed-hide-logo">
		...
		<div class="page-container">
			[@sidebar pattern="admin:userTeamManager"][#include "/admin/include/sidebar.ftl"][/@sidebar]
			<!-- BEGIN CONTENT -->
				<div class="page-content-wrapper">
					<div class="page-content" >
						<div class="page-head">
							<div class="page-title">
								<h1><i class="icon-grid" style="font-size: 20px;"></i>&nbsp;团队成员表管理   </h1>
							</div>
								...
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-globe"></i>团队成员表管理
											</div>
											<div class="actions">
												<a href="${base}/admin/userTeamManager/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														<thead>
															<tr role="row">
																<th class="table-checkbox sorting_disabled" rowspan="1" colspan="1" style="width: 24px;">
				                                                 ...
				                                                 <th ></th> 
				                                                 <th >团队成员id</th> 
				                                                 <th >团内角色，0-普通，1-副团长，2-团长</th> 
				                                                 <th >团id，对应t_user_team_info表的id</th> 
				                                                 <th >入团时间</th> 
														...
														<tbody>
															[#list page.content as userTeamManager]
																<tr class="gradeX [#if (userTeamManager_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${userTeamManager.id}" ></span>
																	</td>
				                                                    <td>${ userTeamManager.id}</td>
				                                                    
				                                                    <td>${ userTeamManager.userId}</td>
				                                                    
				                                                    <td>${ userTeamManager.role}</td>
				                                                    
				                                                    <td>${ userTeamManager.teamId}</td>
				                                                    
				                                                    <td>${ userTeamManager.addTime}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/userTeamManager/edit/${userTeamManager.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/userTeamManager/view/${userTeamManager.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
