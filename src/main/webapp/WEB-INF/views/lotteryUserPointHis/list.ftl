					...
					<div class="page-content" >
						<div class="page-head">
							<div class="page-title">
								<h1><i class="icon-grid" style="font-size: 20px;"></i>&nbsp;用户积分记录表管理   </h1>
							</div>
								...
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-globe"></i>用户积分记录表管理
											</div>
											<div class="actions">
												<a href="${base}/admin/lotteryUserPointHis/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														...
														<tbody>
															[#list page.content as lotteryUserPointHis]
																<tr class="gradeX [#if (lotteryUserPointHis_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${lotteryUserPointHis.id}" ></span>
																	</td>
				                                                    <td>${ lotteryUserPointHis.id}</td>
				                                                    
				                                                    <td>${ lotteryUserPointHis.userId}</td>
				                                                    
				                                                    <td>${ lotteryUserPointHis.beforePoint}</td>
				                                                    
				                                                    <td>${ lotteryUserPointHis.changePoint}</td>
				                                                    
				                                                    <td>${ lotteryUserPointHis.afterPoint}</td>
				                                                    
				                                                    <td>${ lotteryUserPointHis.changeTime}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/lotteryUserPointHis/edit/${lotteryUserPointHis.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/lotteryUserPointHis/view/${lotteryUserPointHis.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
