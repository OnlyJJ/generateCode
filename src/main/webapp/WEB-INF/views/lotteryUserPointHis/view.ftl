				...
				<div class="page-content-wrapper">
					<div class="page-content" >
						...
						class="fa fa-circle"></i></li>
							<li>
								<a href="javascript:;">查看用户积分记录表详情</a>
							</li>
						</ul>
							<div class="row">
								<div class="col-md-12">
														...
														<div class="row">
															...
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<div class="col-md-9">
																		<p class="form-control-static">
																			${lotteryUserPointHis.beforePoint}
																		</p>
																	</div>
																</div>
															</div>
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<div class="col-md-9">
																		<p class="form-control-static">
																			${lotteryUserPointHis.changePoint}
																		</p>
																	</div>
																</div>
															</div>
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<div class="col-md-9">
																		<p class="form-control-static">
																			${lotteryUserPointHis.afterPoint}
																		</p>
																	</div>
																</div>
															</div>
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<div class="col-md-9">
																		<p class="form-control-static">
																			${lotteryUserPointHis.changeTime}
																		</p>
																	</div>
																</div>
															</div>
