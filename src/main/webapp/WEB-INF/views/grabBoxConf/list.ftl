								...
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											...
											<div class="actions">
												<a href="${base}/admin/grabBoxConf/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														<thead>
															<tr role="row">
																<th class="table-checkbox sorting_disabled" rowspan="1" colspan="1" style="width: 24px;">
				                                                 ...
				                                                 <th ></th> 
				                                                 <th >奖品id</th> 
				                                                 <th >奖品类型，0:座驾,1:礼物,2:工具,3:勋章</th> 
				                                                 <th >数量</th> 
				                                                 <th >份数</th> 
				                                                 <th >启用状态，默认0-停用，1-启用</th> 
														...
														<tbody>
															[#list page.content as grabBoxConf]
																<tr class="gradeX [#if (grabBoxConf_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${grabBoxConf.id}" ></span>
																	</td>
				                                                    <td>${ grabBoxConf.id}</td>
				                                                    
				                                                    <td>${ grabBoxConf.priceId}</td>
				                                                    
				                                                    <td>${ grabBoxConf.priceType}</td>
				                                                    
				                                                    <td>${ grabBoxConf.num}</td>
				                                                    
				                                                    <td>${ grabBoxConf.rate}</td>
				                                                    
				                                                    <td>${ grabBoxConf.useFlag}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/grabBoxConf/edit/${grabBoxConf.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/grabBoxConf/view/${grabBoxConf.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
