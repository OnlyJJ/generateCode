			...
			<div class="page-content">
				...
				<div class="page-head">
					...
					<div class="page-title">
						<h1>
							<i class="icon-grid" style="font-size: 20px;"></i>&nbsp;编辑动态评论举报信息
						</h1>
					</div>
				...
				<ul class="page-breadcrumb breadcrumb">
					...
					<li><a href="javascript:;">动态评论举报信息</a></li>
				</ul>
					...
					<div class="col-md-12">
						<div class="portlet light bordered">
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form id="inputForm"
									action="${base}/admin/diaryCommentAccusation/update.jhtml"
									method="post" class="form-horizontal">
									<input type="hidden" name="id" value="${diaryCommentAccusation.id}" />
									<div class="form-body">
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<div class="col-md-9">
														...
														value="${diaryCommentAccusation.userId}"	maxlength="200" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-3">举报人当时的名称</label>
													<div class="col-md-9">
														<input type="text" name="userName"
															id="userName" class="form-control"
														value="${diaryCommentAccusation.userName}"	maxlength="200" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													...
													<div class="col-md-9">
														...
														value="${diaryCommentAccusation.toUserId}"	maxlength="200" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-3">被举报人当时的名称</label>
													<div class="col-md-9">
														<input type="text" name="toUserName"
															id="toUserName" class="form-control"
														value="${diaryCommentAccusation.toUserName}"	maxlength="200" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													...
													<div class="col-md-9">
														...
														value="${diaryCommentAccusation.accusationTime}"	maxlength="200" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-3">被举报的动态评论id</label>
													<div class="col-md-9">
														<input type="text" name="commentId"
															id="commentId" class="form-control"
														value="${diaryCommentAccusation.commentId}"	maxlength="200" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													...
													<div class="col-md-9">
														...
														value="${diaryCommentAccusation.accusationInfo}"	maxlength="200" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-3">后台管理员处理状态,0:新建,1:已处理-删除(违规),2:已处理-未删除(未违规)</label>
													<div class="col-md-9">
														<input type="text" name="mgrState"
															id="mgrState" class="form-control"
														value="${diaryCommentAccusation.mgrState}"	maxlength="200" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													...
													<div class="col-md-9">
														...
														value="${diaryCommentAccusation.operateUserId}"	maxlength="200" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													...
													<div class="col-md-9">
														...
														value="${diaryCommentAccusation.operateTime}"	maxlength="200" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													...
													<div class="col-md-9">
														...
														value="${diaryCommentAccusation.operateComment}"	maxlength="200" />
													</div>
												</div>
											</div>
										</div>
