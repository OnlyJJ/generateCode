					...
					<div class="page-content" >
						<div class="page-head">
							<div class="page-title">
								<h1><i class="icon-grid" style="font-size: 20px;"></i>&nbsp;动态评论举报信息管理   </h1>
							</div>
						...
						<ul class="page-breadcrumb breadcrumb">
							...
							<li>
								<a href="javascript:;">动态评论举报信息管理</a>
							</li>
						</ul>
							<div class="row">
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-globe"></i>动态评论举报信息管理
											</div>
											<div class="actions">
												<a href="${base}/admin/diaryCommentAccusation/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														<thead>
															<tr role="row">
																<th class="table-checkbox sorting_disabled" rowspan="1" colspan="1" style="width: 24px;">
				                                                 ...
				                                                 <th >被举报的动态评论id</th> 
				                                                 <th >举报信息说明</th> 
				                                                 <th >后台管理员处理状态,0:新建,1:已处理-删除(违规),2:已处理-未删除(未违规)</th> 
														...
														<tbody>
															[#list page.content as diaryCommentAccusation]
																<tr class="gradeX [#if (diaryCommentAccusation_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${diaryCommentAccusation.id}" ></span>
																	</td>
				                                                    <td>${ diaryCommentAccusation.id}</td>
				                                                    
				                                                    <td>${ diaryCommentAccusation.userId}</td>
				                                                    
				                                                    <td>${ diaryCommentAccusation.userName}</td>
				                                                    
				                                                    <td>${ diaryCommentAccusation.toUserId}</td>
				                                                    
				                                                    <td>${ diaryCommentAccusation.toUserName}</td>
				                                                    
				                                                    <td>${ diaryCommentAccusation.accusationTime}</td>
				                                                    
				                                                    <td>${ diaryCommentAccusation.commentId}</td>
				                                                    
				                                                    <td>${ diaryCommentAccusation.accusationInfo}</td>
				                                                    
				                                                    <td>${ diaryCommentAccusation.mgrState}</td>
				                                                    
				                                                    <td>${ diaryCommentAccusation.operateUserId}</td>
				                                                    
				                                                    <td>${ diaryCommentAccusation.operateTime}</td>
				                                                    
				                                                    <td>${ diaryCommentAccusation.operateComment}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/diaryCommentAccusation/edit/${diaryCommentAccusation.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/diaryCommentAccusation/view/${diaryCommentAccusation.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
