					...
					<div class="page-content" >
						<div class="page-head">
							<div class="page-title">
								<h1><i class="icon-grid" style="font-size: 20px;"></i>&nbsp;动态模块-后台管理操作历史log管理   </h1>
							</div>
						...
						<ul class="page-breadcrumb breadcrumb">
							...
							<li>
								<a href="javascript:;">动态模块-后台管理操作历史log管理</a>
							</li>
						</ul>
							<div class="row">
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-globe"></i>动态模块-后台管理操作历史log管理
											</div>
											<div class="actions">
												<a href="${base}/admin/diaryMgrOperateLog/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														<thead>
															<tr role="row">
																<th class="table-checkbox sorting_disabled" rowspan="1" colspan="1" style="width: 24px;">
				                                                 ...
				                                                 <th ></th> 
				                                                 <th >操作关联类型,0:动态发布信息,1:评论发布信息,2:动态举报,3:评论举报</th> 
				                                                 <th >关联id</th> 
				                                                 <th ></th> 
				                                                 <th ></th> 
				                                                 <th >操作说明</th> 
														...
														<tbody>
															[#list page.content as diaryMgrOperateLog]
																<tr class="gradeX [#if (diaryMgrOperateLog_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${diaryMgrOperateLog.id}" ></span>
																	</td>
				                                                    <td>${ diaryMgrOperateLog.id}</td>
				                                                    
				                                                    <td>${ diaryMgrOperateLog.refType}</td>
				                                                    
				                                                    <td>${ diaryMgrOperateLog.refId}</td>
				                                                    
				                                                    <td>${ diaryMgrOperateLog.userId}</td>
				                                                    
				                                                    <td>${ diaryMgrOperateLog.operateTime}</td>
				                                                    
				                                                    <td>${ diaryMgrOperateLog.operateComment}</td>
				                                                    
				                                                    <td>${ diaryMgrOperateLog.ip}</td>
				                                                    
				                                                    <td>${ diaryMgrOperateLog.address}</td>
				                                                    
				                                                    <td>${ diaryMgrOperateLog.cOMMENT}</td>
				                                                    
				                                                    <td>${ diaryMgrOperateLog.clientType}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/diaryMgrOperateLog/edit/${diaryMgrOperateLog.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/diaryMgrOperateLog/view/${diaryMgrOperateLog.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
