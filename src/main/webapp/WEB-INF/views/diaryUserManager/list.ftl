					...
					<div class="page-content" >
						<div class="page-head">
							<div class="page-title">
								<h1><i class="icon-grid" style="font-size: 20px;"></i>&nbsp;动态用户管理表管理   </h1>
							</div>
								...
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-globe"></i>动态用户管理表管理
											</div>
											<div class="actions">
												<a href="${base}/admin/diaryUserManager/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														<thead>
															<tr role="row">
																<th class="table-checkbox sorting_disabled" rowspan="1" colspan="1" style="width: 24px;">
				                                                 ...
				                                                 <th ></th> 
				                                                 <th ></th> 
				                                                 <th >用户当前使用动态模块功能状态，0-正常，1-禁用动态发布功能，2-禁用动态除查看外其他功能，3-禁用动态所有功能</th> 
				                                                 <th ></th> 
				                                                 <th ></th> 
				                                                 <th >操作者id</th> 
														...
														<tbody>
															[#list page.content as diaryUserManager]
																<tr class="gradeX [#if (diaryUserManager_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${diaryUserManager.id}" ></span>
																	</td>
				                                                    <td>${ diaryUserManager.id}</td>
				                                                    
				                                                    <td>${ diaryUserManager.userId}</td>
				                                                    
				                                                    <td>${ diaryUserManager.powerStatus}</td>
				                                                    
				                                                    <td>${ diaryUserManager.beginTime}</td>
				                                                    
				                                                    <td>${ diaryUserManager.endTime}</td>
				                                                    
				                                                    <td>${ diaryUserManager.manmgerUserId}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/diaryUserManager/edit/${diaryUserManager.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/diaryUserManager/view/${diaryUserManager.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
