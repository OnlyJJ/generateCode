					...
					<div class="page-content" >
						<div class="page-head">
							<div class="page-title">
								<h1><i class="icon-grid" style="font-size: 20px;"></i>&nbsp;动态-banner管理   </h1>
							</div>
						...
						<ul class="page-breadcrumb breadcrumb">
							...
							<li>
								<a href="javascript:;">动态-banner管理</a>
							</li>
						</ul>
							<div class="row">
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-globe"></i>动态-banner管理
											</div>
											<div class="actions">
												<a href="${base}/admin/diaryBanner/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														...
														<tbody>
															[#list page.content as diaryBanner]
																<tr class="gradeX [#if (diaryBanner_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${diaryBanner.id}" ></span>
																	</td>
				                                                    <td>${ diaryBanner.id}</td>
				                                                    
				                                                    <td>${ diaryBanner.title}</td>
				                                                    
				                                                    <td>${ diaryBanner.titleColor}</td>
				                                                    
				                                                    <td>${ diaryBanner.linkUrl}</td>
				                                                    
				                                                    <td>${ diaryBanner.showImgUrl}</td>
				                                                    
				                                                    <td>${ diaryBanner.isUse}</td>
				                                                    
				                                                    <td>${ diaryBanner.confTime}</td>
				                                                    
				                                                    <td>${ diaryBanner.beginTime}</td>
				                                                    
				                                                    <td>${ diaryBanner.endTime}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/diaryBanner/edit/${diaryBanner.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/diaryBanner/view/${diaryBanner.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
