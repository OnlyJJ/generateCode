			...
			<div class="page-content">
				...
				<div class="page-head">
					...
					<div class="page-title">
						<h1>
							<i class="icon-grid" style="font-size: 20px;"></i>&nbsp;编辑应用统计管理表
						</h1>
					</div>
				...
				<ul class="page-breadcrumb breadcrumb">
					...
					<li><a href="${base}/admin/dayStatMgr/list.jhtml">应用统计管理表管理</a><i
						class="fa fa-circle"></i></li>
					<li><a href="javascript:;">应用统计管理表</a></li>
				</ul>
					...
					<div class="col-md-12">
						<div class="portlet light bordered">
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form id="inputForm"
									action="${base}/admin/dayStatMgr/update.jhtml"
									method="post" class="form-horizontal">
									<input type="hidden" name="id" value="${dayStatMgr.id}" />
									<div class="form-body">
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<div class="col-md-9">
														<input type="text" name="tbName"
															id="tbName" class="form-control"
														value="${dayStatMgr.tbName}"	maxlength="200" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													...
													<div class="col-md-9">
														...
														value="${dayStatMgr.addTime}"	maxlength="200" />
													</div>
												</div>
											</div>
										</div>
