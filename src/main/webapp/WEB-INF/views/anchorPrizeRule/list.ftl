					...
					<div class="page-content" >
						<div class="page-head">
							<div class="page-title">
								<h1><i class="icon-grid" style="font-size: 20px;"></i>&nbsp;主播发奖规则表管理   </h1>
							</div>
								...
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-globe"></i>主播发奖规则表管理
											</div>
											<div class="actions">
												<a href="${base}/admin/anchorPrizeRule/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														<thead>
															<tr role="row">
																<th class="table-checkbox sorting_disabled" rowspan="1" colspan="1" style="width: 24px;">
				                                                 ...
				                                                 <th >主键</th> 
				                                                 <th >对应t_anchor_prize_record表id</th> 
				                                                 <th >定义的规则类型，1-关注主播，2-赠送免费茄子，3-赠送礼物，4-开守护</th> 
				                                                 <th >规则描述</th> 
				                                                 <th >类型为送礼时，对应的t_gift表id</th> 
				                                                 <th >规则条件需要满足的数量</th> 
														...
														<tbody>
															[#list page.content as anchorPrizeRule]
																<tr class="gradeX [#if (anchorPrizeRule_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${anchorPrizeRule.id}" ></span>
																	</td>
				                                                    <td>${ anchorPrizeRule.id}</td>
				                                                    
				                                                    <td>${ anchorPrizeRule.recordId}</td>
				                                                    
				                                                    <td>${ anchorPrizeRule.ruleType}</td>
				                                                    
				                                                    <td>${ anchorPrizeRule.ruleDes}</td>
				                                                    
				                                                    <td>${ anchorPrizeRule.giftId}</td>
				                                                    
				                                                    <td>${ anchorPrizeRule.num}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/anchorPrizeRule/edit/${anchorPrizeRule.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/anchorPrizeRule/view/${anchorPrizeRule.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
