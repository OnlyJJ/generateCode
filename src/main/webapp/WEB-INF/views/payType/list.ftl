					...
					<div class="page-content" >
						<div class="page-head">
							<div class="page-title">
								<h1><i class="icon-grid" style="font-size: 20px;"></i>&nbsp;充值方式管理   </h1>
							</div>
								...
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-globe"></i>充值方式管理
											</div>
											<div class="actions">
												<a href="${base}/admin/payType/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														<thead>
															<tr role="row">
																<th class="table-checkbox sorting_disabled" rowspan="1" colspan="1" style="width: 24px;">
				                                                 ...
				                                                 <th >充值说明：充一送十</th> 
				                                                 <th >充值显示图标</th> 
				                                                 <th >充值回调地址：支付宝回调到我们服务器的地址</th> 
				                                                 <th >是否启用该充值方式，0-停用，1-启用</th> 
				                                                 <th >添加时间</th> 
														...
														<tbody>
															[#list page.content as payType]
																<tr class="gradeX [#if (payType_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${payType.id}" ></span>
																	</td>
				                                                    <td>${ payType.id}</td>
				                                                    ...
				                                                    <td>${ payType.notifyUrl}</td>
				                                                    
				                                                    <td>${ payType.isUse}</td>
				                                                    
				                                                    <td>${ payType.addTime}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/payType/edit/${payType.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/payType/view/${payType.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
