					...
					<div class="page-content" >
						<div class="page-head">
							<div class="page-title">
								<h1><i class="icon-grid" style="font-size: 20px;"></i>&nbsp;客户端推送消息设备信息记录表管理   </h1>
							</div>
						...
						<ul class="page-breadcrumb breadcrumb">
							...
							<li>
								<a href="javascript:;">客户端推送消息设备信息记录表管理</a>
							</li>
						</ul>
							<div class="row">
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-globe"></i>客户端推送消息设备信息记录表管理
											</div>
											<div class="actions">
												<a href="${base}/admin/pushDev/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														<thead>
															<tr role="row">
																<th class="table-checkbox sorting_disabled" rowspan="1" colspan="1" style="width: 24px;">
				                                                 ...
				                                                 <th >目标应用的密钥</th> 
				                                                 <th >接收消息的设备 Token</th> 
				                                                 <th >客户端类型 1-IOS；0-Android；默认0</th> 
				                                                 <th >创建时间</th> 
														...
														<tbody>
															[#list page.content as pushDev]
																<tr class="gradeX [#if (pushDev_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${pushDev.id}" ></span>
																	</td>
				                                                    <td>${ pushDev.id}</td>
				                                                    
				                                                    <td>${ pushDev.userId}</td>
				                                                    
				                                                    <td>${ pushDev.accessId}</td>
				                                                    
				                                                    <td>${ pushDev.secretKey}</td>
				                                                    
				                                                    <td>${ pushDev.token}</td>
				                                                    
				                                                    <td>${ pushDev.appType}</td>
				                                                    
				                                                    <td>${ pushDev.creatTime}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/pushDev/edit/${pushDev.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/pushDev/view/${pushDev.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
