...
<!DOCTYPE html>
	...
	<body class="page-header-fixed page-sidebar-closed-hide-logo page-sidebar-closed-hide-logo">
		...
		<div class="page-container">
			[@sidebar pattern="admin:carPlateConf"][#include "/admin/include/sidebar.ftl"][/@sidebar]
			<!-- BEGIN CONTENT -->
				<div class="page-content-wrapper">
					<div class="page-content" >
						<div class="page-head">
							<div class="page-title">
								<h1><i class="icon-grid" style="font-size: 20px;"></i>&nbsp;车牌配置表管理   </h1>
							</div>
								...
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-globe"></i>车牌配置表管理
											</div>
											<div class="actions">
												<a href="${base}/admin/carPlateConf/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														<thead>
															<tr role="row">
																<th class="table-checkbox sorting_disabled" rowspan="1" colspan="1" style="width: 24px;">
				                                                 ...
				                                                 <th >主键</th> 
				                                                 <th >车牌类型，1-蜜，2-贵，3-尊（后续可扩展）</th> 
				                                                 <th >车牌类型对应的名字，为车牌首字，1-蜜，2-贵，3-尊（后续可扩展）</th> 
				                                                 <th >车牌等级对应的底图</th> 
														...
														<tbody>
															[#list page.content as carPlateConf]
																<tr class="gradeX [#if (carPlateConf_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${carPlateConf.id}" ></span>
																	</td>
				                                                    <td>${ carPlateConf.id}</td>
				                                                    
				                                                    <td>${ carPlateConf.type}</td>
				                                                    
				                                                    <td>${ carPlateConf.name}</td>
				                                                    
				                                                    <td>${ carPlateConf.img}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/carPlateConf/edit/${carPlateConf.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/carPlateConf/view/${carPlateConf.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
