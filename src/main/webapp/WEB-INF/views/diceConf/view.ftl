				...
				<div class="page-content-wrapper">
					<div class="page-content" >
						...
						class="fa fa-circle"></i></li>
							<li>
								<a href="javascript:;">查看猜大小游戏配置表详情</a>
							</li>
						</ul>
							<div class="row">
								<div class="col-md-12">
														...
														<div class="row">
															<div class="col-md-6">
																<div class="form-group">
																	<label class="control-label col-md-3">游戏类型，1平民场，2土豪场:</label>
																	<div class="col-md-9">
															...
															<div class="col-md-6">
																<div class="form-group">
																	<label class="control-label col-md-3">金币基数（底分）:</label>
																	<div class="col-md-9">
																		<p class="form-control-static">
																			${diceConf.baseGold}
																		</p>
															...
															<div class="col-md-6">
																<div class="form-group">
																	<label class="control-label col-md-3">每轮游戏参与玩家总数:</label>
																	<div class="col-md-9">
																		<p class="form-control-static">
																			${diceConf.amount}
																		</p>
															...
															<div class="col-md-6">
																<div class="form-group">
																	<label class="control-label col-md-3">是否启用，0停用，1启用:</label>
																	<div class="col-md-9">
																		<p class="form-control-static">
																			${diceConf.inUse}
																		</p>
