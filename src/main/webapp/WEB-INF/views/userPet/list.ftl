					...
					<div class="page-content" >
						<div class="page-head">
							<div class="page-title">
								<h1><i class="icon-grid" style="font-size: 20px;"></i>&nbsp;用户宠物表管理   </h1>
							</div>
								...
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-globe"></i>用户宠物表管理
											</div>
											<div class="actions">
												<a href="${base}/admin/userPet/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														<thead>
															<tr role="row">
																<th class="table-checkbox sorting_disabled" rowspan="1" colspan="1" style="width: 24px;">
				                                                 ...
				                                                 <th >主键id</th> 
				                                                 <th >用户id</th> 
				                                                 <th >宠物id，对应t_pet_conf表的id</th> 
				                                                 <th >用户自定义的宠物名称，没有修改则用默认名</th> 
				                                                 <th >当前宠物等级</th> 
				                                                 <th >当前宠物经验</th> 
				                                                 <th >宠物状态，0:未使用，1:正在使用</th> 
														...
														<tbody>
															[#list page.content as userPet]
																<tr class="gradeX [#if (userPet_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${userPet.id}" ></span>
																	</td>
				                                                    <td>${ userPet.id}</td>
				                                                    
				                                                    <td>${ userPet.userId}</td>
				                                                    ...
				                                                    <td>${ userPet.petPoint}</td>
				                                                    
				                                                    <td>${ userPet.status}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/userPet/edit/${userPet.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/userPet/view/${userPet.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
