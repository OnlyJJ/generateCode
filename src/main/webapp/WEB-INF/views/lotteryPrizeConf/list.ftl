					...
					<div class="page-content" >
						<div class="page-head">
							<div class="page-title">
								<h1><i class="icon-grid" style="font-size: 20px;"></i>&nbsp;抽奖奖品配置表管理   </h1>
							</div>
								...
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-globe"></i>抽奖奖品配置表管理
											</div>
											<div class="actions">
												<a href="${base}/admin/lotteryPrizeConf/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														<thead>
															<tr role="row">
																<th class="table-checkbox sorting_disabled" rowspan="1" colspan="1" style="width: 24px;">
				                                                 ...
				                                                 <th ></th> 
				                                                 <th >抽奖配置表id（t_lottery_conf）</th> 
				                                                 <th >奖品概率对应的百分比</th> 
				                                                 <th >0:座驾,1:礼物,2:工具,3:勋章,4:金币</th> 
				                                                 <th >奖品id,如:座驾carId,礼物giftId,金币:id指定为0</th> 
				                                                 <th >奖品对应的数量，默认1个</th> 
				                                                 <th >奖品名称</th> 
				                                                 <th >奖品详细描述</th> 
														...
														<tbody>
															[#list page.content as lotteryPrizeConf]
																<tr class="gradeX [#if (lotteryPrizeConf_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${lotteryPrizeConf.id}" ></span>
																	</td>
				                                                    <td>${ lotteryPrizeConf.id}</td>
				                                                    
				                                                    <td>${ lotteryPrizeConf.confId}</td>
				                                                    
				                                                    <td>${ lotteryPrizeConf.rate}</td>
				                                                    
				                                                    <td>${ lotteryPrizeConf.type}</td>
				                                                    
				                                                    <td>${ lotteryPrizeConf.prizeId}</td>
				                                                    
				                                                    <td>${ lotteryPrizeConf.prizeNum}</td>
				                                                    
				                                                    <td>${ lotteryPrizeConf.prizeName}</td>
				                                                    
				                                                    <td>${ lotteryPrizeConf.prizeDesc}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/lotteryPrizeConf/edit/${lotteryPrizeConf.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/lotteryPrizeConf/view/${lotteryPrizeConf.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
