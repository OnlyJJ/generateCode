...
<!DOCTYPE html>
	...
	<body class="page-header-fixed page-sidebar-closed-hide-logo page-sidebar-closed-hide-logo">
		...
		<div class="page-container">
			[@sidebar pattern="admin:userTeamApply"][#include "/admin/include/sidebar.ftl"][/@sidebar]
			<!-- BEGIN CONTENT -->
								...
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											...
											<div class="actions">
												<a href="${base}/admin/userTeamApply/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														<thead>
															<tr role="row">
																<th class="table-checkbox sorting_disabled" rowspan="1" colspan="1" style="width: 24px;">
				                                                 ...
				                                                 <th >申请入团用户</th> 
				                                                 <th >申请入团的团id</th> 
				                                                 <th >状态，0-申请中，1-通过，2-被拒绝，3-已退出</th> 
				                                                 <th >申请时间</th> 
														...
														<tbody>
															[#list page.content as userTeamApply]
																<tr class="gradeX [#if (userTeamApply_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${userTeamApply.id}" ></span>
																	</td>
				                                                    <td>${ userTeamApply.id}</td>
				                                                    
				                                                    <td>${ userTeamApply.userId}</td>
				                                                    
				                                                    <td>${ userTeamApply.teamId}</td>
				                                                    
				                                                    <td>${ userTeamApply.status}</td>
				                                                    
				                                                    <td>${ userTeamApply.creatTime}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/userTeamApply/edit/${userTeamApply.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/userTeamApply/view/${userTeamApply.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
