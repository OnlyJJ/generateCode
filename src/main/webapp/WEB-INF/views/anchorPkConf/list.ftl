					...
					<div class="page-content" >
						<div class="page-head">
							<div class="page-title">
								<h1><i class="icon-grid" style="font-size: 20px;"></i>&nbsp;主播pk配置表管理   </h1>
							</div>
								...
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-globe"></i>主播pk配置表管理
											</div>
											<div class="actions">
												<a href="${base}/admin/anchorPkConf/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														<thead>
															<tr role="row">
																<th class="table-checkbox sorting_disabled" rowspan="1" colspan="1" style="width: 24px;">
				                                                 ...
				                                                 <th ></th> 
				                                                 <th >pk模式，目前：1-指定礼物金币数量，2-所有礼物金币数量</th> 
				                                                 <th >指定的pk礼物，当modle为1时，此字段不为空，多个礼物逗号隔开</th> 
				                                                 <th >pk时间，固定为30/60/90/120/180</th> 
				                                                 <th >pk发起者</th> 
				                                                 <th >pk接受者</th> 
				                                                 <th >是否生效，默认0-无效，1-有效，当pk接受者接受后，设置为1：有效</th> 
				                                                 <th >生效时间</th> 
				                                                 <th >添加时间</th> 
														...
														<tbody>
															[#list page.content as anchorPkConf]
																<tr class="gradeX [#if (anchorPkConf_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${anchorPkConf.id}" ></span>
																	</td>
				                                                    <td>${ anchorPkConf.id}</td>
				                                                    
				                                                    <td>${ anchorPkConf.modle}</td>
				                                                    
				                                                    <td>${ anchorPkConf.gifts}</td>
				                                                    
				                                                    <td>${ anchorPkConf.pkTime}</td>
				                                                    
				                                                    <td>${ anchorPkConf.challenger}</td>
				                                                    
				                                                    <td>${ anchorPkConf.beChallenger}</td>
				                                                    
				                                                    <td>${ anchorPkConf.validFlag}</td>
				                                                    
				                                                    <td>${ anchorPkConf.validTime}</td>
				                                                    
				                                                    <td>${ anchorPkConf.addTime}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/anchorPkConf/edit/${anchorPkConf.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/anchorPkConf/view/${anchorPkConf.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
