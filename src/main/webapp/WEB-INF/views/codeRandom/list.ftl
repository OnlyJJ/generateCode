...
<!DOCTYPE html>
	...
	<body class="page-header-fixed page-sidebar-closed-hide-logo page-sidebar-closed-hide-logo">
		...
		<div class="page-container">
			[@sidebar pattern="admin:codeRandom"][#include "/admin/include/sidebar.ftl"][/@sidebar]
			<!-- BEGIN CONTENT -->
								...
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											...
											<div class="actions">
												<a href="${base}/admin/codeRandom/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														<thead>
															<tr role="row">
																<th class="table-checkbox sorting_disabled" rowspan="1" colspan="1" style="width: 24px;">
				                                                 ...
				                                                 <th >id</th> 
				                                                 <th >随机号</th> 
				                                                 <th >userId是否使用,0:未使用,1:已使用</th> 
				                                                 <th >roomId是否使用,0:未使用,1:已使用</th> 
														...
														<tbody>
															[#list page.content as codeRandom]
																<tr class="gradeX [#if (codeRandom_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${codeRandom.id}" ></span>
																	</td>
				                                                    <td>${ codeRandom.id}</td>
				                                                    
				                                                    <td>${ codeRandom.code}</td>
				                                                    
				                                                    <td>${ codeRandom.isUserUse}</td>
				                                                    
				                                                    <td>${ codeRandom.isRoomUse}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/codeRandom/edit/${codeRandom.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/codeRandom/view/${codeRandom.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
