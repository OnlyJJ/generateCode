...
<!DOCTYPE html>
	...
	<body class="page-header-fixed page-sidebar-closed-hide-logo page-sidebar-closed-hide-logo">
		...
		<div class="page-container">
			[@sidebar pattern="admin:userTeamLevel"][#include "/admin/include/sidebar.ftl"][/@sidebar]
			<!-- BEGIN CONTENT -->
				<div class="page-content-wrapper">
					<div class="page-content" >
						<div class="page-head">
							<div class="page-title">
								<h1><i class="icon-grid" style="font-size: 20px;"></i>&nbsp;跑骚团等级管理表管理   </h1>
							</div>
						...
						<ul class="page-breadcrumb breadcrumb">
							...
							<li>
								<a href="javascript:;">跑骚团等级管理表管理</a>
							</li>
						</ul>
							<div class="row">
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-globe"></i>跑骚团等级管理表管理
											</div>
											<div class="actions">
												<a href="${base}/admin/userTeamLevel/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														...
														<tbody>
															[#list page.content as userTeamLevel]
																<tr class="gradeX [#if (userTeamLevel_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${userTeamLevel.id}" ></span>
																	</td>
				                                                    <td>${ userTeamLevel.id}</td>
				                                                    
				                                                    <td>${ userTeamLevel.level}</td>
				                                                    
				                                                    <td>${ userTeamLevel.userCount}</td>
				                                                    
				                                                    <td>${ userTeamLevel.keepPoint}</td>
				                                                    
				                                                    <td>${ userTeamLevel.totalPoint}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/userTeamLevel/edit/${userTeamLevel.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/userTeamLevel/view/${userTeamLevel.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
