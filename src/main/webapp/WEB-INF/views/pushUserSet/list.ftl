...
<!DOCTYPE html>
	...
	<body class="page-header-fixed page-sidebar-closed-hide-logo page-sidebar-closed-hide-logo">
		...
		<div class="page-container">
			[@sidebar pattern="admin:pushUserSet"][#include "/admin/include/sidebar.ftl"][/@sidebar]
			<!-- BEGIN CONTENT -->
				<div class="page-content-wrapper">
					<div class="page-content" >
						<div class="page-head">
							<div class="page-title">
								<h1><i class="icon-grid" style="font-size: 20px;"></i>&nbsp;用户消息推送设置管理   </h1>
							</div>
						...
						<ul class="page-breadcrumb breadcrumb">
							...
							<li>
								<a href="javascript:;">用户消息推送设置管理</a>
							</li>
						</ul>
							<div class="row">
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-globe"></i>用户消息推送设置管理
											</div>
											<div class="actions">
												<a href="${base}/admin/pushUserSet/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														<thead>
															<tr role="row">
																<th class="table-checkbox sorting_disabled" rowspan="1" colspan="1" style="width: 24px;">
				                                                 ...
				                                                 <th ></th> 
				                                                 <th >设置的用户id，以用户区分，不以设备区分</th> 
				                                                 <th >是否响铃，0否，1是，默认0</th> 
				                                                 <th >是否震动，0否，1是，默认0</th> 
				                                                 <th >推送类型，1-关注提醒，2-开播提醒</th> 
														...
														<tbody>
															[#list page.content as pushUserSet]
																<tr class="gradeX [#if (pushUserSet_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${pushUserSet.id}" ></span>
																	</td>
				                                                    <td>${ pushUserSet.id}</td>
				                                                    
				                                                    <td>${ pushUserSet.userId}</td>
				                                                    
				                                                    <td>${ pushUserSet.ring}</td>
				                                                    
				                                                    <td>${ pushUserSet.vibrate}</td>
				                                                    
				                                                    <td>${ pushUserSet.pushType}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/pushUserSet/edit/${pushUserSet.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/pushUserSet/view/${pushUserSet.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
