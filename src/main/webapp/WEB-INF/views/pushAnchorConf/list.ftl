					...
					<div class="page-content" >
						<div class="page-head">
							<div class="page-title">
								<h1><i class="icon-grid" style="font-size: 20px;"></i>&nbsp;主播资源推送配置表管理   </h1>
							</div>
						...
						<ul class="page-breadcrumb breadcrumb">
							...
							<li>
								<a href="javascript:;">主播资源推送配置表管理</a>
							</li>
						</ul>
							<div class="row">
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-globe"></i>主播资源推送配置表管理
											</div>
											<div class="actions">
												<a href="${base}/admin/pushAnchorConf/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														<thead>
															<tr role="row">
																<th class="table-checkbox sorting_disabled" rowspan="1" colspan="1" style="width: 24px;">
				                                                 ...
				                                                 <th >主播id</th> 
				                                                 <th >昵称</th> 
				                                                 <th >使用状态，0-停用，1-启用</th> 
				                                                 <th >推荐开始时间，如10:00:00</th> 
				                                                 <th >推荐结束时间（配置的主播只有在推送时间内才会推送）</th> 
				                                                 <th >创建时间</th> 
														...
														<tbody>
															[#list page.content as pushAnchorConf]
																<tr class="gradeX [#if (pushAnchorConf_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${pushAnchorConf.id}" ></span>
																	</td>
				                                                    <td>${ pushAnchorConf.id}</td>
				                                                    
				                                                    <td>${ pushAnchorConf.anchorId}</td>
				                                                    
				                                                    <td>${ pushAnchorConf.nickname}</td>
				                                                    
				                                                    <td>${ pushAnchorConf.useStatus}</td>
				                                                    
				                                                    <td>${ pushAnchorConf.beginTime}</td>
				                                                    
				                                                    <td>${ pushAnchorConf.endTime}</td>
				                                                    
				                                                    <td>${ pushAnchorConf.creatTime}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/pushAnchorConf/edit/${pushAnchorConf.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/pushAnchorConf/view/${pushAnchorConf.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
