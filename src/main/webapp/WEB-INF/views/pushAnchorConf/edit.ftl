			...
			<div class="page-content">
				...
				<div class="page-head">
					...
					<div class="page-title">
						<h1>
							<i class="icon-grid" style="font-size: 20px;"></i>&nbsp;编辑主播资源推送配置表
						</h1>
					</div>
				...
				<ul class="page-breadcrumb breadcrumb">
					...
					<li><a href="javascript:;">主播资源推送配置表</a></li>
				</ul>
					...
					<div class="col-md-12">
						<div class="portlet light bordered">
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form id="inputForm"
									action="${base}/admin/pushAnchorConf/update.jhtml"
									method="post" class="form-horizontal">
									<input type="hidden" name="id" value="${pushAnchorConf.id}" />
									<div class="form-body">
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<div class="col-md-9">
														...
														value="${pushAnchorConf.anchorId}"	maxlength="200" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													...
													<div class="col-md-9">
														...
														value="${pushAnchorConf.nickname}"	maxlength="200" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-3">使用状态，0-停用，1-启用</label>
													<div class="col-md-9">
														<input type="text" name="useStatus"
															id="useStatus" class="form-control"
														value="${pushAnchorConf.useStatus}"	maxlength="200" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-3">推荐开始时间，如10:00:00</label>
													<div class="col-md-9">
														<input type="text" name="beginTime"
															id="beginTime" class="form-control"
														value="${pushAnchorConf.beginTime}"	maxlength="200" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-3">推荐结束时间（配置的主播只有在推送时间内才会推送）</label>
													<div class="col-md-9">
														<input type="text" name="endTime"
															id="endTime" class="form-control"
														value="${pushAnchorConf.endTime}"	maxlength="200" />
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													...
													<div class="col-md-9">
														...
														value="${pushAnchorConf.creatTime}"	maxlength="200" />
													</div>
												</div>
											</div>
										</div>
