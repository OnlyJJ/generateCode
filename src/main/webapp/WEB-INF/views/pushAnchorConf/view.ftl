				...
				<div class="page-content-wrapper">
					<div class="page-content" >
						...
						class="fa fa-circle"></i></li>
							<li>
								<a href="javascript:;">查看主播资源推送配置表详情</a>
							</li>
						</ul>
							<div class="row">
								<div class="col-md-12">
