					...
					<div class="page-content" >
						<div class="page-head">
							<div class="page-title">
								<h1><i class="icon-grid" style="font-size: 20px;"></i>&nbsp;用户关注主播提醒设置管理   </h1>
							</div>
						...
						<ul class="page-breadcrumb breadcrumb">
							...
							<li>
								<a href="javascript:;">用户关注主播提醒设置管理</a>
							</li>
						</ul>
							<div class="row">
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-globe"></i>用户关注主播提醒设置管理
											</div>
											<div class="actions">
												<a href="${base}/admin/pushUserSetAttention/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														...
														<tbody>
															[#list page.content as pushUserSetAttention]
																<tr class="gradeX [#if (pushUserSetAttention_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${pushUserSetAttention.id}" ></span>
																	</td>
				                                                    <td>${ pushUserSetAttention.id}</td>
				                                                    
				                                                    <td>${ pushUserSetAttention.userId}</td>
				                                                    
				                                                    <td>${ pushUserSetAttention.toUserId}</td>
				                                                    
				                                                    <td>${ pushUserSetAttention.pushFlag}</td>
				                                                    
				                                                    <td>${ pushUserSetAttention.creatTime}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/pushUserSetAttention/edit/${pushUserSetAttention.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/pushUserSetAttention/view/${pushUserSetAttention.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
