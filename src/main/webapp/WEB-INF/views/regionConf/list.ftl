...
<!DOCTYPE html>
	...
	<body class="page-header-fixed page-sidebar-closed-hide-logo page-sidebar-closed-hide-logo">
		...
		<div class="page-container">
			[@sidebar pattern="admin:regionConf"][#include "/admin/include/sidebar.ftl"][/@sidebar]
			<!-- BEGIN CONTENT -->
								...
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											...
											<div class="actions">
												<a href="${base}/admin/regionConf/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														...
														<tbody>
															[#list page.content as regionConf]
																<tr class="gradeX [#if (regionConf_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${regionConf.id}" ></span>
																	</td>
				                                                    <td>${ regionConf.id}</td>
				                                                    
				                                                    <td>${ regionConf.region}</td>
				                                                    
				                                                    <td>${ regionConf.regionId}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/regionConf/edit/${regionConf.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/regionConf/view/${regionConf.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
