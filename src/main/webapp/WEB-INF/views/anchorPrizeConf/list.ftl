					...
					<div class="page-content" >
						<div class="page-head">
							<div class="page-title">
								<h1><i class="icon-grid" style="font-size: 20px;"></i>&nbsp;主播发奖奖励配置表管理   </h1>
							</div>
						...
						<ul class="page-breadcrumb breadcrumb">
							...
							<li>
								<a href="javascript:;">主播发奖奖励配置表管理</a>
							</li>
						</ul>
							<div class="row">
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-globe"></i>主播发奖奖励配置表管理
											</div>
											<div class="actions">
												<a href="${base}/admin/anchorPrizeConf/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														<thead>
															<tr role="row">
																<th class="table-checkbox sorting_disabled" rowspan="1" colspan="1" style="width: 24px;">
				                                                 ...
				                                                 <th >奖励类型，0-文字，1-金币，2-礼物</th> 
				                                                 <th >奖励id，针对奖励类型为2的情况，此id对应t_gift表的id</th> 
				                                                 <th >奖励份数</th> 
														...
														<tbody>
															[#list page.content as anchorPrizeConf]
																<tr class="gradeX [#if (anchorPrizeConf_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${anchorPrizeConf.id}" ></span>
																	</td>
				                                                    <td>${ anchorPrizeConf.id}</td>
				                                                    
				                                                    <td>${ anchorPrizeConf.recordId}</td>
				                                                    
				                                                    <td>${ anchorPrizeConf.prizeType}</td>
				                                                    
				                                                    <td>${ anchorPrizeConf.prizeId}</td>
				                                                    
				                                                    <td>${ anchorPrizeConf.prizeNum}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/anchorPrizeConf/edit/${anchorPrizeConf.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/anchorPrizeConf/view/${anchorPrizeConf.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
