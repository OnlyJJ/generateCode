					...
					<div class="page-content" >
						<div class="page-head">
							<div class="page-title">
								<h1><i class="icon-grid" style="font-size: 20px;"></i>&nbsp;用户座驾车牌管理表管理   </h1>
							</div>
						...
						<ul class="page-breadcrumb breadcrumb">
							...
							<li>
								<a href="javascript:;">用户座驾车牌管理表管理</a>
							</li>
						</ul>
							<div class="row">
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-globe"></i>用户座驾车牌管理表管理
											</div>
											<div class="actions">
												<a href="${base}/admin/carPlate/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														<thead>
															<tr role="row">
																<th class="table-checkbox sorting_disabled" rowspan="1" colspan="1" style="width: 24px;">
				                                                 ...
				                                                 <th >主键，作为车牌id(plateId)</th> 
				                                                 <th >用户id</th> 
				                                                 <th >关联t_car_plate_conf表id</th> 
				                                                 <th >车牌号，如A00001</th> 
				                                                 <th >是否启用，默认0-未启用，1-启用</th> 
				                                                 <th >有效期开始时间</th> 
				                                                 <th >有效期结束时间</th> 
				                                                 <th >备注</th> 
														...
														<tbody>
															[#list page.content as carPlate]
																<tr class="gradeX [#if (carPlate_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${carPlate.id}" ></span>
																	</td>
				                                                    <td>${ carPlate.id}</td>
				                                                    
				                                                    <td>${ carPlate.userId}</td>
				                                                    
				                                                    <td>${ carPlate.confId}</td>
				                                                    
				                                                    <td>${ carPlate.plateNumer}</td>
				                                                    
				                                                    <td>${ carPlate.inUse}</td>
				                                                    
				                                                    <td>${ carPlate.beginTime}</td>
				                                                    
				                                                    <td>${ carPlate.endTime}</td>
				                                                    
				                                                    <td>${ carPlate.remark}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/carPlate/edit/${carPlate.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/carPlate/view/${carPlate.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
