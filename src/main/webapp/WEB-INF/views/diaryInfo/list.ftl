					...
					<div class="page-content" >
						<div class="page-head">
							<div class="page-title">
								<h1><i class="icon-grid" style="font-size: 20px;"></i>&nbsp;动态信息表管理   </h1>
							</div>
								...
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-globe"></i>动态信息表管理
											</div>
											<div class="actions">
												<a href="${base}/admin/diaryInfo/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														<thead>
															<tr role="row">
																<th class="table-checkbox sorting_disabled" rowspan="1" colspan="1" style="width: 24px;">
				                                                 ...
				                                                 <th ></th> 
				                                                 <th ></th> 
				                                                 <th >动态发布来源,0:普通用户,1:主播,2:系统发布</th> 
				                                                 <th >动态文本信息</th> 
				                                                 <th >动态链接url</th> 
				                                                 <th >发布时间</th> 
				                                                 <th >被赞总数</th> 
				                                                 ...
				                                                 <th ></th> 
				                                                 <th >排序权重,值越大越靠前</th> 
				                                                 <th >是否被用户撤回,0:否,1:是</th> 
				                                                 <th >管理控制状态,0:新建,1:审核违规-删除,2-审核未违规</th> 
														...
														<tbody>
															[#list page.content as diaryInfo]
																<tr class="gradeX [#if (diaryInfo_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${diaryInfo.id}" ></span>
																	</td>
				                                                    <td>${ diaryInfo.id}</td>
				                                                    
				                                                    <td>${ diaryInfo.userId}</td>
				                                                    
				                                                    <td>${ diaryInfo.publicFromType}</td>
				                                                    
				                                                    <td>${ diaryInfo.diaryTextInfo}</td>
				                                                    
				                                                    <td>${ diaryInfo.diaryLinkUrl}</td>
				                                                    
				                                                    <td>${ diaryInfo.publicTime}</td>
				                                                    
				                                                    <td>${ diaryInfo.prizeTotalNum}</td>
				                                                    
				                                                    <td>${ diaryInfo.belittleTotalNum}</td>
				                                                    
				                                                    <td>${ diaryInfo.commentTotalNum}</td>
				                                                    
				                                                    <td>${ diaryInfo.publicIp}</td>
				                                                    
				                                                    <td>${ diaryInfo.publicAddress}</td>
				                                                    
				                                                    <td>${ diaryInfo.clientType}</td>
				                                                    
				                                                    <td>${ diaryInfo.remark}</td>
				                                                    
				                                                    <td>${ diaryInfo.sortWeight}</td>
				                                                    
				                                                    <td>${ diaryInfo.isUserCancel}</td>
				                                                    
				                                                    <td>${ diaryInfo.mgrState}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/diaryInfo/edit/${diaryInfo.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/diaryInfo/view/${diaryInfo.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
