					...
					<div class="page-content" >
						<div class="page-head">
							<div class="page-title">
								<h1><i class="icon-grid" style="font-size: 20px;"></i>&nbsp;每日统计数据表管理   </h1>
							</div>
								...
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-globe"></i>每日统计数据表管理
											</div>
											<div class="actions">
												<a href="${base}/admin/dayStat20170822/add.jhtml"  class="btn btn-default btn-sm "> <i class="fa fa-plus"></i>添加</a>
											...
											<div class="portlet-body">
												...
												<div id="sample_1_wrapper" class="dataTables_wrapper no-footer"><div class="table-scrollable">
													<table class="table table-striped table-bordered table-hover dataTable no-footer" id="table_list" role="grid" aria-describedby="sample_2_info">
														<thead>
															<tr role="row">
																<th class="table-checkbox sorting_disabled" rowspan="1" colspan="1" style="width: 24px;">
				                                                 ...
				                                                 <th ></th> 
				                                                 <th >客户端类型,0-android,1-IOS</th> 
				                                                 <th >平台id</th> 
				                                                 <th >添加时间，yyyyMMddHH</th> 
				                                                 <th >手机卡标识</th> 
				                                                 <th >登录帐号</th> 
				                                                 <th >渠道id</th> 
				                                                 <th >产品id</th> 
														...
														<tbody>
															[#list page.content as dayStat20170822]
																<tr class="gradeX [#if (dayStat20170822_index+1) % 2 != 0]odd[#else]even[/#if]" role="row">
																	<td>
																		<span><input type="checkbox" name="ids" class="checkboxes" value="${dayStat20170822.id}" ></span>
																	</td>
				                                                    <td>${ dayStat20170822.id}</td>
				                                                    
				                                                    <td>${ dayStat20170822.clientType}</td>
				                                                    
				                                                    <td>${ dayStat20170822.platformId}</td>
				                                                    
				                                                    <td>${ dayStat20170822.addtime}</td>
				                                                    
				                                                    <td>${ dayStat20170822.uuid}</td>
				                                                    
				                                                    <td>${ dayStat20170822.userAccount}</td>
				                                                    
				                                                    <td>${ dayStat20170822.channelId}</td>
				                                                    
				                                                    <td>${ dayStat20170822.productId}</td>
				                                                    
				                                                    <td>${ dayStat20170822.version}</td>
				                                                    
				                                                    <td>${ dayStat20170822.isLogin}</td>
				                                                    
				                                                    <td>${ dayStat20170822.isAdd}</td>
				                                                    
				                                                    <td>${ dayStat20170822.isReg}</td>
				                                                    
				                                                    <td>${ dayStat20170822.isAct}</td>
				                                                    
				                                                    <td>${ dayStat20170822.retention}</td>
				                                                    
				                                                    <td>${ dayStat20170822.isVaild}</td>
				                                                    
				                                                    <td>${ dayStat20170822.retentionVaild}</td>
				                                                    
				                                                    <td>${ dayStat20170822.douId}</td>
				                                                    
																	<td style="width: 125px;">
																		<a href="${base}/admin/dayStat20170822/edit/${dayStat20170822.id}.jhtml" class="btn default btn-xs purple "> <i class="fa fa-edit"></i> 编辑</a>
																		<a href="${base}/admin/dayStat20170822/view/${dayStat20170822.id}.jhtml" class="btn default btn-xs green-stripe ">查看</a>
																	</td>
																</tr>
															[/#list]
														</tbody>
