...
public class TemplateModelUtil {
	...
	public static TemplateModel getTemplateModel(ModelVO model) {
		...
		System.err.println("subPackageName"+subPackageName);

		if (!StringUtil.isNullOrEmpty(subPackageName)) {
			PropertiesUtil.DAO_PACKAGE = PropertiesUtil.DAO_PACKAGE ;
			PropertiesUtil.XML_PACKAGE = PropertiesUtil.XML_PACKAGE + "." + subPackageName;
			PropertiesUtil.SERVICE_PACKAGE = PropertiesUtil.SERVICE_PACKAGE ;
			PropertiesUtil.SERVICEIMPL_PACKAGE = PropertiesUtil.SERVICEIMPL_PACKAGE ;
			PropertiesUtil.CONTROLLER_PACKAGE = PropertiesUtil.CONTROLLER_PACKAGE ;
			PropertiesUtil.MODEL_PACKAGE = PropertiesUtil.MODEL_PACKAGE ;
	...
	public static String renderFileName(Map<String, Object> paramMap, String fileName) {
		...
		return result;//CarParkRecordDao.ftl
	}
